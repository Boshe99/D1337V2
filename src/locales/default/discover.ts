export default {
  assistants: {
    ...
    status: {
      ...
      support: '有各种问题请复制链接发送到 <1>support@d1337.ai</1> 进行咨询。',
      unpublished: {
        subtitle:
          '当前访问的助手正在进行版本审核中，如果有疑问复制链接发送问题到 <1>support@d1337.ai</1> 进行咨询。',
        title: '助手正在审核中',
      },
    },
    suggestions: '相关推荐',
  ...
  models: {
    ...
    providerInfo: {
      apiTooltip: 'D1337 支持为此提供商使用自定义 API 密钥。',
      input: '输入价格',
